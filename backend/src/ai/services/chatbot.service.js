...
function buildFallbackAnswer(knowledge) {
  ...
  if (sections.length === 0) {
    return 'He thong AI dang tam gian doan nen minh chua the tra loi tu nhien luc nay. Tuy vay, minh cung chua tim thay du lieu lien quan truc tiep trong he thong. Ban hay thu hoi ro hon ve san pham, bai viet hoac khuyen mai.';
  }

  return `Tro ly AI dang tam gian doan nen minh tra loi theo du lieu hien co trong he thong. ${sections.join(' ')}`.trim();
}
